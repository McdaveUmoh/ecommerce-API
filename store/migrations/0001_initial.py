# Generated by Django 5.1.5 on 2025-02-19 20:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_status', models.CharField(choices=[('P', 'Pending'), ('C', 'Completed'), ('F', 'Failed')], default=[('P', 'Pending'), ('C', 'Completed'), ('F', 'Failed')], max_length=1)),
